...
## Uninstall
To uninstall the PSO Operator, delete the project/namespace in which the PSO operator is installed. It is recommended to install the PSO Operator in a new project and not add any other pods to this project/namespace. 
